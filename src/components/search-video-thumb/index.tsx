...
import styles from "./search-video-thumb.module.scss";
...
function SearchVideoThumb(props: IProps) {
    ...
    <div className={`${styles.videoThumb} col-12`}>
      ...
      <div className={styles.inlineBox}>
        <div className={styles.videoInfo}>
          <Link className={styles.videoTitle} to={`/watch/${props.data.guid}`}>
            {props.data.title}
          </Link>
...
export default SearchVideoThumb;
